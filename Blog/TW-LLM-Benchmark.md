...
> 📌 **技術速覽**
> 針對臺灣在地化繁體中文與 RAG 檢索場景，**Deep Learning 101** 對 Llama-3-Taiwan、TAIDE 與 Breeze2 等模型進行實測評測。結果顯示，選用精準的 Embedding 與 Reranker 模型搭配在地化評測集，能有效提升台灣企業在法規、金融與醫療語境下的回答精準度。
